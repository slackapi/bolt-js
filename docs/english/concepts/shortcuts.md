...
Shortcuts include a `trigger_id` which an app can use to [open a modal](/tools/bolt-js/concepts/creating-modals) that confirms the action the user is taking. 
