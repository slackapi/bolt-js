...
![Interactivity & Shortcuts page](/img/bolt-js/img/bolt-js/interactivity-and-shortcuts-page.png "Interactivity & Shortcuts page")

Second, select **Event Subscriptions** from the side and update the **Request URL**:

![Event Subscriptions page](/img/bolt-js/img/bolt-js/event-subscriptions-page.png "Event Subscriptions page")
