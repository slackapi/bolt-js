...
:::info[A workspace where development can happen is also needed.]
...
- Follow along with the steps that went into making this app on the [creating an app](/tools/bolt-js/creating-an-app) guide for an educational overview.
