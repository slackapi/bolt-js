[@slack/bolt](../../../../index.md) / [webApi](../index.md) / AdminInviteRequestsDeniedListArguments

# Interface: AdminInviteRequestsDeniedListArguments

Defined in: node\_modules/@slack/web-api/dist/types/request/admin/inviteRequests.d.ts:10
