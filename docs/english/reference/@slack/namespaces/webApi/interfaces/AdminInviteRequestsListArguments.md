[@slack/bolt](../../../../index.md) / [webApi](../index.md) / AdminInviteRequestsListArguments

# Interface: AdminInviteRequestsListArguments

Defined in: node\_modules/@slack/web-api/dist/types/request/admin/inviteRequests.d.ts:14
