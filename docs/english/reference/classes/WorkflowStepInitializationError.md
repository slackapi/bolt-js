[@slack/bolt](../index.md) / WorkflowStepInitializationError

# ~~Class: WorkflowStepInitializationError~~

Defined in: [src/errors.ts:163](https://github.com/slackapi/bolt-js/blob/main/src/errors.ts#L163)
...
```ts
new WorkflowStepInitializationError(message?): WorkflowStepInitializationError;
```
...
```ts
new WorkflowStepInitializationError(message?, options?): WorkflowStepInitializationError;
```
...
```ts
code: ErrorCode = ErrorCode.WorkflowStepInitializationError;
```

Defined in: [src/errors.ts:164](https://github.com/slackapi/bolt-js/blob/main/src/errors.ts#L164)
