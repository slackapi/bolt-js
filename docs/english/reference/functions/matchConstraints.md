...
### constraints
  ...
  \| [`ActionConstraints`](../interfaces/ActionConstraints.md)\<[`SlackAction`](../type-aliases/SlackAction.md)\>
  \| [`ViewConstraints`](../interfaces/ViewConstraints.md)
  \| [`ShortcutConstraints`](../interfaces/ShortcutConstraints.md)\<[`SlackShortcut`](../type-aliases/SlackShortcut.md)\>
  \| [`OptionsConstraints`](../interfaces/OptionsConstraints.md)\<[`SlackOptions`](../type-aliases/SlackOptions.md)\>
