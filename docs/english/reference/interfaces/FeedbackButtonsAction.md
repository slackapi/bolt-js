...
- [`BasicElementAction`](BasicElementAction.md)\<`"feedback_buttons"`\>
...
Defined in: [src/types/actions/block-action.ts:61](https://github.com/slackapi/bolt-js/blob/main/src/types/actions/block-action.ts#L61)
...
Defined in: [src/types/actions/block-action.ts:60](https://github.com/slackapi/bolt-js/blob/main/src/types/actions/block-action.ts#L60)
