---
sidebar_label: "IconButtonAction"
---

[@slack/bolt](../index.md) / IconButtonAction
...
- [`BasicElementAction`](BasicElementAction.md)\<`"icon_button"`\>
...
Defined in: [src/types/actions/block-action.ts:68](https://github.com/slackapi/bolt-js/blob/main/src/types/actions/block-action.ts#L68)
...
Defined in: [src/types/actions/block-action.ts:69](https://github.com/slackapi/bolt-js/blob/main/src/types/actions/block-action.ts#L69)
