...
export function RunmeLink(props) {
    return React.createElement(BrowserOnly, null, () => React.createElement(RunmeLinkComponent, { ...props }));
}
function RunmeLinkComponent({ reference, metastring }) {
    ...
    return (React.createElement("a", { href: `vscode://stateful.runme?${getRunmeLink(reference, metastring)}`, className: 'runmeLink', target: "_blank", style: buttonStyles }, codeblockConfig.runmeLinkLabel));
}
export function getRunmeLink(snippetUrl, metastring) {
