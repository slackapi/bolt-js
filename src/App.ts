...
export interface AppOptions {
   ...
   *
   * See {@link https://docs.slack.dev/node-slack-sdk/reference/web-api/interfaces/WebClientOptions} for more information.
   */
...
export default class App<AppCustomContext extends StringIndexed = StringIndexed> {
  ...
  private initAuthorizeIfNoTokenIsGiven(token?: string, authorize?: Authorize): Authorize<boolean> | undefined {
    ...
    if (authorize === undefined && !usingOauth) {
      throw new AppInitializationError(
        `${tokenUsage} \n\nSince you have not provided a token or authorize, you might be missing one or more required oauth installer options. See https://docs.slack.dev/bolt-js/concepts/authenticating-oauth/ for these required fields.\n`,
      );
      // biome-ignore lint/style/noUselessElse: I think this is a biome issue actually...
