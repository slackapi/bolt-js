...
export enum ErrorCode {
  ...
  CustomFunctionRuntimeError = 'slack_bolt_custom_function_runtime_error',
}
...
export class CustomFunctionRuntimeError extends Error implements CodedError {
  public code = ErrorCode.CustomFunctionRuntimeError;
}
